export default {
  game: {
    ...
    challengeMessage: '{{player.nickname}} has challenged {{otherPlayer.nickname}} in {{gameName}}!',
    cannotChallengeBot: 'You cannot challenge a bot!',
    cannotChallengeYourself: 'You cannot challenge yourself',
    declineMessage: '**{{player.nickname}}** has has declined or did not the accept the challenge in time',
