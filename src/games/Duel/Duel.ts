...
import {
  ButtonInteraction, Collection, CommandInteraction, EmbedFieldData, GuildMember, InteractionCollectorOptions, Message, MessageActionRowOptions, MessageButtonOptions, MessageEmbedOptions,
} from 'discord.js';
